...
typedef enum{
    ...
    UMSocialYXMessageTypeText,      //易信消息文本类型
    UMSocialYXMessageTypeImage,     //易信消息图片类型
    UMSocialYXMessageTypeApp,       //易信消息应用类型
    UMSocialYXMessageTypeWeb,       //易信消息网页类型
    UMSocialYXMessageTypeMusic,     //易信消息音乐类型
    UMSocialYXMessageTypeVideo,     //易信消息视频类型
