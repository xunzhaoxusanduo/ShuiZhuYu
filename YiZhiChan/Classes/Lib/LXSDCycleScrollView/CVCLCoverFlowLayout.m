...
/**
 *  根据当前的indexPath返回在所有section中所处的indexPath
 *
 */
...
/**
 *  根据在所有section中所处的indexPath返回所处的section
 *
 */
...
/**
 *  根据在所有section中所处的indexPath返回所处的indexPath
 *
 */
...
/**
 *  返回rect内的UICollectionViewLayoutAttributes集合
 *
 */
...
/**
 *  返回indexPath处的UICollectionViewLayoutAttributes
 *
 */
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    frame.origin.y = (self.collectionView.bounds.size.height - self.cellSize.height) / 2.0 + 20;
...
/**
 *  根据当前偏移的X值计算与uicollectionview中心点的比例
 *
 */
