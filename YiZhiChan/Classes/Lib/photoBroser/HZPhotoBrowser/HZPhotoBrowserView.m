...
- (UIImageView *)imageview
{
    if (!_imageview) {
        ...
        [_imageview addSubview:subTitleBgImageView];
...
- (void)setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder
{
    if ((self.subTitle == nil) || (self.subTitle.length == 0)) {
        ...
        self.subTitleLbl.text = self.subTitle;
    }
...
- (void)adjustFrames
{
    ...
    self.subTitleBgImageView.frame = CGRectMake(0, CGRectGetHeight(self.imageview.frame) - 30, CGRectGetWidth(self.imageview.frame), 30);
    self.subTitleLbl.frame = self.subTitleBgImageView.bounds;
}
