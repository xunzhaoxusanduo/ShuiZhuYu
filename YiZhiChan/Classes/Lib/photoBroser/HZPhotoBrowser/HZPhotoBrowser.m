...
- (void)setupImageOfImageViewForIndex:(NSInteger)index
{
    ...
    view.subTitle = [self getSubTitle:index];
...
- (NSString *)getSubTitle:(NSInteger)index {
    if ([self.delegate respondsToSelector:@selector(photoBrowser:subTitle:)]) {
        return [self.delegate photoBrowser:self subTitle:index];
    }
