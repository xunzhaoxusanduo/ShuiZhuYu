...
@interface LXShuiZhuYuHttpTool : NSObject
 ...
 *  @param failure 请求失败后的回调
 */
+ (void)syncGetWithURL:(NSString *)url params:(NSDictionary *)params success:(void (^)(id responseObject))success failure:(void (^)(NSError *))failure;
